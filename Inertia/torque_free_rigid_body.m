...
hax = quiver3(0,0,0,h_I(1),h_I(2),h_I(3),'Linewidth',3,...
    'Color',[0.5,0.5,0.5],'AutoScale','off','MaxHeadSize',0.5);
if xtrace
...
haxb = quiver3(0,0,0,hs_norm(1,1)*axscale,hs_norm(1,2)*axscale,...
    hs_norm(1,3)*axscale,'Linewidth',3,'Color',[0.5,0.5,0.5],...
    'AutoScale','off','MaxHeadSize',0.5);
...
for j = 2:length(t)
    ...
    set(haxb,'UData',hs_norm(j,1)*axscale,'VData',hs_norm(j,2)*axscale,...
                'WData',hs_norm(j,3)*axscale)
